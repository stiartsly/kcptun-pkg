#! /bin/sh
### BEGIN INIT INFO
# Provides:          shadowtun-oc
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Starts the shadowtun-oc daemon
# Description:       Starts the shadowtun-oc daemon
### END INIT INFO

# PATH should only include /usr/* if it runs after the mountnfs.sh script
PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC="ShadowTunnel for OpenConnect"
NAME=shadowtun-oc
DAEMON=/usr/bin/shadowtun-prog
CONFIG_FILE=/etc/shadowtun/oc.conf
